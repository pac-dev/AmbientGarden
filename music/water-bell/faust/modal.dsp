...
mode0 = vslider("mode0", 0, 0, 1, 0.0001);
mode1 = vslider("mode1", 0, 0, 1, 0.0001);
mode2 = vslider("mode2", 0, 0, 1, 0.0001);
mode3 = vslider("mode3", 0, 0, 1, 0.0001);
mode4 = vslider("mode4", 0, 0, 1, 0.0001);
