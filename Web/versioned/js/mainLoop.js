...
import { beaconGroup, initBeaconPool, initPatchPool } from './beacons/beaconPool.js';
...
export const initWorld = async ({ patchLoader, nearMap, farMap }) => {
