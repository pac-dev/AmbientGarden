...
const enable = () => {
	...
	const tgtDiskMap = new THREE.TextureLoader().load(window.agVersionedPath+'img/tgtdisk.png');
	...
	const tgtLockMap = new THREE.TextureLoader().load(window.agVersionedPath+'img/tgtlock.png');
...
const disable = () => {
	...
	// this is checked by the patch pool, so it stops all patches
