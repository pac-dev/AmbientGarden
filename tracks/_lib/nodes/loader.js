...
export class LoaderNode extends TeaNode {
    ...
    constructor(mainPath, instantiate) {
        ...
        if (!mainPath.endsWith('/main.js')) {
            throw new Error('invalid path to subtrack main file: ' + mainPath);
        }
    ...
    async initInstance(instance, params) {
        ...
        console.log('worklet: done starting subtrack '+this.mainPath);
        return instance;
    }
    async remove(instance) {
        ...
        console.log('worklet: stopped subtrack '+this.mainPath);
    }
    /**
