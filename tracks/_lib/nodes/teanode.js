...
const makeFrameAdapter = (srcNode, tgtNode) => {
    ...
    if (numSrc === numTgt) {
        ...
        throw new Error('Unhandled invalid connection from '
            + `"${describe(srcNode)}" to "${describe(tgtNode)}"`);
    }
};